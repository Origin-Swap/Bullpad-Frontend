...
import { BUSD, CAKE, BULL } from '@pancakeswap/tokens'
...
const cakeBusdPairMap = {
  ...
  [ChainId.CORE]: {
    address: Pair.getAddress(BULL[ChainId.CORE], BUSD[ChainId.CORE]),
    tokenA: BULL[ChainId.CORE],
    tokenB: BUSD[ChainId.CORE],
  },
}
