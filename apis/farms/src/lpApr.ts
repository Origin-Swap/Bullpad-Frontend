...
const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.GOERLI]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.CORE]: 'https://thegraph.coredao.org/subgraphs/name/Bullpad-block',
}
...
const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.GOERLI]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.CORE]: 'https://thegraph.coredao.org/subgraphs/name/bullexchangev2',
}
...
const getBlockAtTimestamp = async (timestamp: number, chainId = ChainId.CORE) => {
  try {
