...
const DataRow: React.FC<React.PropsWithChildren<{ transaction: Transaction }>> = ({ transaction }) => {
  ...
  return (
    <ResponsiveGrid>
      <LinkExternal href={getBlockExploreLink(transaction.hash, 'transaction', chainName === 'CORE' && ChainId.CORE)}>
        <Text>
      ...
      <LinkExternal href={getBlockExploreLink(transaction.sender, 'address', chainName === 'CORE' && ChainId.CORE)}>
