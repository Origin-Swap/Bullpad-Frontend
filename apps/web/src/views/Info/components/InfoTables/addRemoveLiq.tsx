...
const DataRow: React.FC<React.PropsWithChildren<{ transaction: Transaction }>> = ({ transaction }) => {
  ...
  return (
    <ResponsiveGrid>
      <LinkExternal href={getBlockExploreLink(transaction.hash, 'transaction', chainName === '5IRE' && ChainId.SIRE_TESTNET)}>
        <Text>
      ...
      <LinkExternal href={getBlockExploreLink(transaction.sender, 'address', chainName === '5IRE' && ChainId.SIRE_TESTNET)}>
