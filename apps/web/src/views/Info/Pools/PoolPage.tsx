...
const PoolPage: React.FC<React.PropsWithChildren<{ address: string }>> = ({ address: routeAddress }) => {
  console.log('PoolPage rendered with address:', routeAddress)  // New log
  ...
  // console.log('poolData fetched:', poolData);  // Existing log
  ...
  // useEffect(() => {
  //   console.log('useEffect - poolData:', poolData);  // New log
  // }, [poolData])
