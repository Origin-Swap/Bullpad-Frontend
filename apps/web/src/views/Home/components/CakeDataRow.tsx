 ...
 * https://twitter.com/bulllaunchpad/status/1523913527626702849
...
const CakeDataRow = () => {
  ...
  const {
    ...
    async () => {
      const totalSupplyCall = { abi: cakeAbi, address: mainnetTokens.bull.address, name: 'totalSupply' }
      const burnedTokenCall = {
        abi: cakeAbi,
        address: mainnetTokens.bull.address,
        name: 'balanceOf',
