...
const StakeAction: React.FC<React.PropsWithChildren<FarmCardActionsProps>> = ({
  ...
  const crossChainWarningText = useMemo(() => {
    return isFirstTime
      ? t('A small amount of %nativeToken% is required for the first-time setup of cross-chain BULL farming.', {
  ...
  const [onPresentDeposit] = useModal(
    <FarmUI.DepositModal
      ...
      showCrossChainFarmWarning={chainId !== ChainId.VANAR && chainId !== ChainId.CORE}
