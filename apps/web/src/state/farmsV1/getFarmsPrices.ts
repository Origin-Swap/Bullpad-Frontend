...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === mainnetTokens.bull.symbol) {
    return hasTokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (farm.quoteToken.symbol === mainnetTokens.weth.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === mainnetTokens.weth.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === mainnetTokens.bull.symbol) {
